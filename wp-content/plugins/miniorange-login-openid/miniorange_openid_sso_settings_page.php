										...
										<table class="mo_openid_settings_table">
											...
											<tr>
												...
												<td><br /><input type="submit" name="submit" value="Next" style="width:100px;"
													...
													<input type="button" value="Login" id="mo_openid_go_back_registration" style="width:100px;"
													class="button button-primary button-large" />
												</td>
											</tr>
										</table>
				...
				<table class="mo_openid_settings_table">
					...
					<tr>
						...
						<td><input type="submit" name="submit"
							class="button button-primary button-large" />
						<input type="button" value="Register" id="mo_openid_go_back" style="width:80px;"
													class="button button-primary button-large" />
						</td>
					</tr>
				</table>
