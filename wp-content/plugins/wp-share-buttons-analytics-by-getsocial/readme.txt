...
**Integration with MailChimp**: As of October/2015 we started providing a native integration with MailChimp to our paid customers. Users of the Subscriber Bar & Price Alert features (both paid) are now able to push emails automatically, in real-time, to their MailChimp lists. 
