<?php function weblizar_scripts()
        {      
                ...
                wp_enqueue_script('waypoint', WL_TEMPLATE_DIR_URI .'/js/waypoint.js', array('jquery'));
                wp_enqueue_script('counter', WL_TEMPLATE_DIR_URI .'/js/counter.js', array('jquery'));
                wp_enqueue_script('highchartjs', WL_TEMPLATE_DIR_URI .'/js/highchartjs/highcharts.js', array('jquery'));
                if(is_front_page()){
                /*Carofredsul Slides*/
		...
		wp_enqueue_script('equalheightjs', WL_TEMPLATE_DIR_URI .'/js/jquery.equalheights.min.js', array('jquery'));
                /*PhotoBox JS*/
